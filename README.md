A package of automatic .bash scripts and .sql queries for MSSQL Server for Linux. Scripts create .bak files and .sql queries for restore made backups of all databases running on sql server.
